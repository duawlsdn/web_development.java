...
/*
    싱글톤 패턴(Singleton Patten)
        ...
        그 인스턴스에 접근할 수 있는 전역적인 접근법을 제공하는 패턴. 예를들어, 데이터베이스 연결과 같은
    ...
    싱글톤 패턴의 특징
        ...
        3. 인스턴스의 생명 주기 관리 : 클래스 자체가 인스턴스 생성을 관리하므로, 다른 객체들이 직접 인스턴스를 생성하거나
        폐기 할 수 없음.
     ...
     싱글톤 패턴의 단점 :
        ...
        Samsung.java 클래스 / SmartPhone.java 클래스 생성
 */
public class FactoryMain {
    public static void main(String[] args) {
        ...
        SmartPhone smartPhone1 = factory1.produceSmartPhone();  // 새로운 방식으로 객체 생성
        ...
        // smartPhone1 의 경우 SmartPhone 클래스의 객체인데(참조자료형인데), 왜 sout(smartPhone1) 했는데
        // 주소값이 아니라 필드가 다 튀어나올까요? -> SmartPhone 클래스의 @ToString 애너테이션 때문
