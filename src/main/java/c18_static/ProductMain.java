...
public class ProductMain {
    ...
    // 여기에 나오지는 않지만 getter 와 setter 가 정의 -> 이것을 main 메서드 영역 내에서 객체 생성 및
    // 필드를 set 하고, 그 값을 get 할 수 있습니다.
...
//
//        System.out.println("현재 시리얼 넘버 : " + Product.autoIncrement);
//        System.out.println("p1의 시리얼 넘버 : " + product2.getSerialNumber());

        // 클래스명 객체명 = new 클래스명()    -> 여기서부터는 Product 의 객체가 아니라 ProductMain 의 객체입니다.
        ProductMain productMain1 = new ProductMain();
        /*
            productMain1의 name 에 "pm1"을 set 하고, 콘솔창에 pm1 이 나오도록 getter 를 이용
         */
