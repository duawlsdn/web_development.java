...
/*
    향상된 For문(Enhanced For Sentence)
        ...
        같은 자료형으로 지정해야 함.
        즉, 배열을 선언할때 지정한 자료형과 꺼낼 자료형이 일치해야 함을 의미
        반복 대상 요소를 하나씩 변수에 대입하면서 진행하고, 반복 대상의 길이만큼 꺼내어 반복
 */
...
//        }
        ...
        // 기본 for 문을 이용하여 합을 구한 후 sum1에 대입해서 출력
        for (int i = 0; i < scores.length; i++) {
            sum1 += scores[i];
        }
        System.out.println(sum1);

        // 향상 for 문을 이용하여 합을 구한 후 sum2에 대입해서 출력
