...
/*
    배열의 필요성 :
        ...
        을 출력하면,[I@36baf30c, [I@7a81197d 와 같은 값이 출력되고 {1,2,3,4,5}와 같은 방식으로 출력되지 않음

        여기서 일반 변수와 참조 변수 개념에 대해 짚고 넘어갈 필요가 있음
...
public class ArrayTest01 {
    public static void main(String[] args) {
        ...
        arr[3] = 400;
        arr[4] = 500;
        int[] arr2 = {1,2,3,4,5};   // 배열 선언 방식 2 ->

        // 곧장 arr 을 출력하고자 하면 주소값이 출력
//        System.out.println(arr);
//        System.out.println(arr2);

        // String 은 기본 자료형이 아니라 클래스이기 때문에 실제로는 객체 생성을 통해 데이터를 삽입한다는 근거 :
...
//        System.out.println(arr[5]);
        ...
        // index 범위를 알고 있다고 가정했을 때, 반복문을 통해 배열의 각 요소를 출력할 수 있음.
//        for(int i = 0; i < 5; i++){
...
//        }
        ...
        // arr 객체의 field 인 length 를 활용하여 컴퓨터가 알아서 배열의 크기를 찾아서 반복문을 통해 출력
